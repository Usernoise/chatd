    ...
    try:
        ...
        response = openai_client.chat.completions.create(
            ...
            messages=[
                {
                    "role": "system", 
                    "content": """Ты создаешь официальные корпоративные портреты на основе описания человека из чата.
...
Основывайся на описании человека и создай КРАТКИЙ английский промпт (максимум 50 слов) для генерации изображения."""
                ...
                {
                    "role": "user", 
                    "content": f"Создай промпт для официального корпоративного портрета на основе этого описания:\n\n{clean_info}"
                }
            ],
            temperature=0.7,
            max_tokens=200
